...
Ball *balls_create(void) { return malloc(sizeof(Ball) * ball_count); }

void balls_destroy(Ball *balls) { free(balls); }

void ball_render(const Ball *ball) { DrawCircleV(ball->pos, ball->radius, RAYWHITE); }
